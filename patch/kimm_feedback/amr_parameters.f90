...
! Precision for radiative transfer
  ...
  logical::conduction_ion=.false.! Heat diffusion of ions activated
  logical::isotrope_cond=.false. ! Activate isotropic conduction instead of anisotropic
  logical::semi_implicit=.false. ! Semi-implicit integrator for anisotropic conduction
  ...
  logical::fix_temp_diff=.true.  ! Cosmic ray diffusion temperature fix
  ...
  real(dp)::Etotcool=0.0d0    ! Local amount of ecr lost to cooling
  real(dp)::Etotcool_all=0.0d0! Total amount of ecr lost to cooling
  real(dp)::Etot_injected_all=0.0d0! Total amount of ecr lost to cooling
  real(dp)::Etot_injected=0.0d0! Local amount of ecr lost to cooling
  real(dp)::fcr=0.0d0         ! Fraction of jet CR energy
...
!  real(dp)::eff_sfbk=1.0D0
  ...
  logical ::use_particle_type=.false. ! read/write type of a particle
