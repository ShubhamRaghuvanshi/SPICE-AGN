...
subroutine virtual_tree_fine(ilevel)
  ...
  if(star.or.sink) then
     ...
     if(metal) particle_data_width=particle_data_width+2  !Oscar + zp2
...
subroutine fill_comm(ind_part,ind_com,ind_list,np,ilevel,icpu)
  ...
  if(star.or.sink)then
     ...
     if(metal)then
        ...
        current_property = current_property+1
        do i=1,np
           reception(icpu,ilevel)%up(ind_com(i),current_property)=zp2(ind_part(i))   !Oscar
        end do
        current_property = current_property+1
     end if
     do i=1,np
...
subroutine empty_comm(ind_com,np,ilevel,icpu)
  ...
  if(star.or.sink)then
     ...
     if(metal)then
        ...
        current_property = current_property+1
        do i=1,np
           zp2(ind_part(i))=emission(icpu,ilevel)%up(ind_com(i),current_property)
        end do
        current_property = current_property+1
     end if
     do i=1,np
