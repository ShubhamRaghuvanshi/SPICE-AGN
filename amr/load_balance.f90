...
#ifdef RT
  use rt_hydro_commons, ONLY: nrtvartrace, rtuold
#endif
#endif
  use bisection
  use mpi_mod
                 ...
                 if(cpu_map(ind_cell(i))==myid.and.son(ind_cell(i))==0)then
                    ...
                    !tracer 
                      ...
                      if(pic)then
                        ...
                        if (MC_tracer .and. ilevel >= tracer_first_balance_levelmin) then
...
subroutine defrag
  ...
  do igrid=1,igridmax
     rtuold(iskip2+igrid,ivar)=real(hilbert_key(igrid),kind=rtdp)
  end do
  end do
  end do
