...
img1 = Image.open("gastemp_proj_star+sink_z12.png")
img2 = Image.open("gastemp_proj_star+sink_z11.png")
img3 = Image.open("gastemp_proj_star+sink_z10.png")

img4 = Image.open("gastemp_proj_star+sn+sink_z12.png")
img5 = Image.open("gastemp_proj_star+sn+sink_z11.png")
img6 = Image.open("gastemp_proj_star+sn+sink_z10.png")

img7 = Image.open("gastemp_proj_star+sink+agn_z12.png")
img8 = Image.open("gastemp_proj_star+sink+agn_z11.png")
img9 = Image.open("gastemp_proj_star+sink+agn_z10.png")

img10 = Image.open("gastemp_proj_star+sn+sink+agn_z12.png")
img11 = Image.open("gastemp_proj_star+sn+sink+agn_z11.png")
img12 = Image.open("gastemp_proj_star+sn+sink+agn_z10.png")
...
fignanme="collage_temperature_proj.png"
