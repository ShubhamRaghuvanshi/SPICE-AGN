program part2sfr
  ...
  character(LEN=128)::nomfich,repository,outfich,filedens,filetype='ascii'
  ...
  read(10,*)
  write(*,*)boxlen,t,aexp,h0,omega_m,omega_l,omega_k,omega_b,unit_l,unit_d,unit_t,unit_m  
