...
#ifdef NTRACEGROUPS
     do i=1,np
        reception(icpu,ilevel)%up(ind_com(i),current_property+2)=ptracegroup(ind_part(i))
     end do
     current_property = current_property+1
#endif
  end if
...
#ifdef NTRACEGROUPS
     do i=1,np
        ptracegroup(ind_part(i))=emission(icpu,ilevel)%up(ind_com(i),current_property+2)
     end do
     current_property = current_property+1
#endif
  end if
