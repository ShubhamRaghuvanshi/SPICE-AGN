module pm_parameters
 ...
 ! real(dp)::max_mass_nsc=1d15               ! Maximum mass of the Nuclear Star Cluster (msink)
  ...
  real(dp)::r_tracer=0d0         !Maximum tracer radius in which to initiate tracers, optional
  real(dp),dimension(1:NDIM)::c_tracer=-1.0  !Center of sphere in which to initiate tracers, optional. By default, set to boxlen/2
  !tracer_params
