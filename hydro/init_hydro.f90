subroutine init_hydro
  ...
  real(udp),dimension(:),allocatable::xx
  real(dp)::gamma2
  ...
  !shubham
  !write(*,*) "Dimentions of uold :", ncell, nvar, myid 
  !shubham 

  !shubham
  !if(star) then 
  !  allocate(star_formation_rate(1:ncell))
  !  allocate(star_formation_efficiency(1:ncell))
  !  star_formation_rate=0.0d0
  !  star_formation_efficiency=0.0d0
  !endif 
  !shubham 
  ...
  if(nrestart>0)then
     ...
     if(myid==1)then
        ...
        !shubham
        write(*,*)'ncpu2, nvar2, ndim2, nlevelmax2, nboundary2, gamma2', ncpu2, nvar2, ndim2, nlevelmax2, nboundary2, gamma2  
        !shubham
